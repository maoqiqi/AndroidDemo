 ...
 * @date 2016/12/23
 */
public class LaunchModeSingleTaskActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public LaunchModeSingleTaskActivity() {
        Log.e(TAG, "创建：" + TAG);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMessage.setText("Activity singleTask");
    }
