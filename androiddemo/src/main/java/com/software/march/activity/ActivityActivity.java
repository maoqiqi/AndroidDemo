...
public class ActivityActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化视图对象
        Button btnRestoreInstance = findViewById(R.id.btn_restore_instance);
        Button btnStartMode = findViewById(R.id.btn_start_mode);
        Button btnLaunchMode = findViewById(R.id.btn_launch_mode);
        Button btnIntentFilter = findViewById(R.id.btn_intent_filter);
        Button btnCommonComponent = findViewById(R.id.btn_common_component);
