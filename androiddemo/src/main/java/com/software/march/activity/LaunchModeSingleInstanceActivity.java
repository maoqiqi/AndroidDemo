 ...
 * @date 2016/12/23
 */
public class LaunchModeSingleInstanceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public LaunchModeSingleInstanceActivity() {
        Log.e(TAG, "创建：" + TAG);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMessage.setText("Activity singleInstance");
    }
