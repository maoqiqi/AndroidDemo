 ...
 * @date 2016/12/23
 */
public class LaunchModeSingleTopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public LaunchModeSingleTopActivity() {
        Log.e(TAG, "创建：" + TAG);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMessage.setText("Activity singleTop");
    }
